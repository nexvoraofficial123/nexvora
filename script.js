...
const PRODUCTS = [
  {
    id: 1, name: 'WiWU Type C EB314 Wired Earphone Ergonomic Design Headsets',
    category: 'Earbuds',
  ...
  {
    id: 2, name: 'WiWU Type C EB314 Wired Earphone Ergonomic Design Headsets ',
    category: 'Earbuds',
  ...
  {
    id: 3, name: 'Wiwu Airbuds 5 ENC Plus Wireless Premium Earbuds with Free Case ',
    category: 'Earbuds',
  ...
  {
    id: 4, name: 'WiWU iphone EB319  Stereo Wired Premium Earbuds   ',
    category: 'Earbuds',
  ...
  {
    id: 11, name: 'WIWU 30W Essen GaN Type C Fast Charger Wi-G008',
    category: 'USB & Charging Cables',
    price: 3050, oldPrice: 3650,
    badge: 'sale', rating: 3.9, reviews: 215,
    colors: ['White'],
    image: 'images/CHC30/CHC30W3.jpeg',
  ...
  {
    id: 12, name: 'WiWU Wi‑CC030 Nano Lite 35W USB‑C + USB Car Charger Mini Dual Port Fast Charge Adapter',
    category: 'USB & Charging Cables',
    ...
    {
    id: 13, name: 'WiWU  High-Speed USB-C to iphone Stellar Series 1M Charging Cable',
    category: 'USB & Charging Cables',
    ...
    gallery: [
      ...
      {
    id: 14, name: 'WiWU Fast Charging USB-C to iphone 27w silicone  Cable ',
    category: 'USB & Charging Cables',
    price: 1250, oldPrice: 2100,
    ...
    {
    id: 15, name: 'WiWU Wi-C057 USB-C to C TITAN LINK Series 60W Fast Charging Cable',
    category: 'USB & Charging Cables',
    price: 1250, oldPrice: 2100,
    badge: 'sale', rating: 5.7, reviews: 119,
    colors: ['Black'],
    image: 'images/CBLC2C/CBLC2C01.webp',
    ...
    gallery: [
     ...
     {
    id: 16, name: 'WiWU Wi-C060 1.2m 66W USB C TITAN LINK Series Charging Cable with Dual USB-C+iphone (C+C+IP)    ',
    category: 'USB & Charging Cables',
    ...
    {
    id: 17, name: 'WiWU Wi-C054 USB-A to C TITAN LINK Series 1m Fast Charging Cable ',
    category: 'USB & Charging Cables',
  ...
  {
    id: 30, name: 'Iphone 11 Silicone Case',
    category: 'Phone Cases',
    price: 750, oldPrice: 1000,
    badge: 'hot', rating: 4.5, reviews: 61,
    colors: ['Red', 'Gray', 'Blue'],
    image: 'images/phonecases/IPHONE 11BLU.jpg',
    description: 'Protective case for your iPhone 11.',
    gallery: [
      'images/phonecases/IPHONE 11BLU.jpg',
      'images/phonecases/IPHONE 11GRY.png',
      'images/phonecases/IPHONE 11RED.png',
      'images/phonecases/IPHONE 11BLU.jpg'
    ]
  },
    {
    id: 31, name: 'Iphone 12 & 12 Pro Max Silicone Case ',
    category: 'Phone Cases',
    price: 750, oldPrice:1000,
    badge: 'hot', rating: 4.5, reviews: 75,
    colors: ['Black', 'Gray'],
    image: 'images/phonecases/IPHONE 12&PROASH.jpg',
    description: 'Protective case for your iPhone 12 & 12 Pro Max.',
    gallery: [
      'images/phonecases/IPHONE 12&PROASH.jpg',
      'images/phonecases/IPHONE 12&PROBLU.jpg',
    
    ]
  },
    {
    id: 32, name: 'Iphone 13 Printed Stylish Phone case ',
    category: 'Phone Cases',
    price: 850, oldPrice: 1250 ,
    badge: 'hot', rating: 4.5, reviews: 118,
    colors: ['Nike',],
    image: 'images/phonecases/IPHONE 13 1.png',
    description: 'Protective & Printed stylish phone case for your iPhone 13.',
    gallery: [
      'images/phonecases/IPHONE 13 1.png',
     
    ]
  },
    {
    id: 33, name: 'Iphone 13 Printed Stylish Phone case',
    category: 'Phone Cases',
    price: 850, oldPrice: 1250,
    badge: 'hot', rating: 4.5, reviews: 102,
    colors: ['Pinky'],
    image: 'images/phonecases/IPHONE 13 2.png',
    description: 'Protective & Printed stylish phone case for your iPhone 13.',
    gallery: [
      'images/phonecases/IPHONE 13 2.png',
      
    ]
  },
    {
    id: 34, name: 'Iphone 13 Printed Stylish Phone case',
    category: 'Phone Cases',
    price: 850, oldPrice: 1250,
    badge: 'hot', rating: 4.5, reviews: 121,
    colors: ['adidas'],
    image: 'images/phonecases/IPHONE 13.png',
    description: 'Protective & Printed stylish phone case for your iPhone 13.',
    gallery: [
      'images/phonecases/IPHONE 13.png',
    ]
  },
    {
    id: 35, name: 'Iphone 14 Printed Stylish Phone case',
    category: 'Phone Cases',
    price: 850, oldPrice: 1250,
    badge: 'hot', rating: 4.5, reviews: 107,
    colors: ['Korean Yellow'],
    image: 'images/phonecases/IPHONE 14.png',
    description: 'Protective & Printed stylish phone case for your iPhone 14.',
    gallery: [
      'images/phonecases/IPHONE 14.png',
      
    ]
  },
    {
    id: 36, name: 'Iphone 14 Silicone Case',
    category: 'Phone Cases',
    price: 750, oldPrice: 1000,
    badge: 'hot', rating: 4.5, reviews: 118,
    colors: ['Gray', 'Purple', 'Red'],
    image: 'images/phonecases/IPHONE 14PPL.jpg',
    description: 'Protective case for your iPhone 14.',
    gallery: [
      'images/phonecases/IPHONE 14GRY.jpg',
      'images/phonecases/IPHONE 14PPL.jpg',
      'images/phonecases/IPHONE 14RED.jpg',
    
    ]
  },
    {
    id: 37, name: 'Redmi Note 14 4G Silicone phone Case',
    category: 'Phone Cases',
    price: 550, oldPrice: 850,
    badge: 'hot', rating: 4.5, reviews: 75,
    colors: ['Black', 'Blue'],
    image: 'images/phonecases/RM144GBLUE.png',
    description: 'Protective case for your Redmi Note 14 4G.',
    gallery: [
      'images/phonecases/RM144GBL.png',
      'images/phonecases/RM144GBLUE.png',
   
    ]
  },
    {
    id: 38, name: 'Samsung A05 Silicone phone Case',
    category: 'Phone Cases',
    price: 550, oldPrice: 750,
    badge: 'hot', rating: 4.5, reviews: 38,
    colors: ['Black','Blue'],
    image: 'images/phonecases/S A05BL.png',
    description: 'Protective case for your Samsung A05.',
    gallery: [
      'images/phonecases/S A05BLU.png',
      'images/phonecases/S A05BL.png',
      
    ]
  },
    {
    id: 39, name: 'Samsung A16 Nilkin phone Case',
    category: 'Phone Cases',
    price: 650, oldPrice: 1250,
    badge: 'hot', rating: 4.5, reviews: 128,
    colors: ['Blue'],
    image: 'images/phonecases/S A16.png',
    description: 'Protective case for your Samsung A16.',
    gallery: [
      'images/phonecases/S A16.png',
      
    ]
  },
    {
    id: 40, name: 'Iphone 13/13 PRO/14/16E Tempered glasses',
    category: 'Phone Cases',
    price: 300, oldPrice: 450,
    badge: 'hot', rating: 4.5, reviews: 92,
    colors: ['iphone','Samsung'],
    image: 'images/phonecases/IPHTEM.jpg',
    description: 'Protective Tempered glasses for your iPhone.',
    gallery: [
      'images/phonecases/IPHTEM.jpg',
     
    ]
  },
    {
    id: 41, name: 'Redmi 15C 4G/5G, Tempered glasses',
    category: 'Phone Cases',
    price: 300, oldPrice: 450,
    badge: 'hot', rating: 4.5, reviews: 38,
    colors: ['iphone','Samsung'],
    image: 'images/phonecases/RDMTEM.jpg',
    description: 'Protective Tempered glasses for your Redmi 15C 4G/5G Phones.',
    gallery: [
      'images/phonecases/RDMTEM.jpg',
      'images/phonecases/RMTEM.jpg',
    ]
  },
  
  {
    id: 62, name: 'Plokama Live K8 Selfie Stick with Bluetooth Remote  ',
    category: 'Camera Accessories',
    price: 1850, oldPrice: 2500,
    badge: 'OFFER', rating: 4.4, reviews: 77,
    colors: ['Black'],
    image: 'images/PLOK8/PLOK8 2.jpg',
    description: 'Freely, easy to use, 360º angle adjustment Easy to carry and disassemble, Easy to take photos and videos.',
    gallery: [
      'images/PLOK8/PLOK8 3.webp',
      'images/PLOK8/PLOK8 4.png',
      'images/PLOK8/PLOK8D.jpg'
    ]
  },
  {
    ...
    badge: 'Hot', rating: 3.4, reviews: 74,
    colors: ['Silver'],
  ...
  {
    id: 102, name: 'Wiwu WI-C059 Titanlink USB-Type-A to USB-C+Micro+iphone 1.2m Fast Charger',
    category: 'USB & Charging Cables',
    ...
    gallery: [
      'images/CHUSB23/CHUSB23001.webp',
  ...
  {
    id: 104, name: 'WIWU WI-G007 Type C ESSEN CHARGER 20W GAN FAST ',
    category: 'USB & Charging Cables',
