...
const PRODUCTS = [
  {
    ...
    category: 'Earbuds',
    price: 2150, oldPrice: 2650,
    badge: 'sale', rating: 4.8, reviews: 124,
    colors: ['Black', 'White',],
    image: 'image/products/earbuds/EB314W 1.webp',
    description: 'WiWU Type C Wired Earphone EB314 Ergonomic Design Sports Headsets with 3.5mm Audio Jack, In-Ear Earphones with Mic for Phone, Laptop, PC, Tablet, Music, Gaming',
    gallery: [
      'image/products/earbuds/EB314B 2.webp',
      'image/products/earbuds/EB314W 3.webp',
      'image/products/earbuds/EB314B 4.webp',
      'image/products/earbuds/EB314D.jpeg'
    ]
  },
  {
    id: 2, name: 'WiWU Lightning Stereo Wired Earbuds (Iphone) EB319',
    category: 'Earbuds',
    price: 3200, oldPrice: 3900,
    badge: ['White',],
    image: 'images/products/earbuds/item_img_32342.png',
    description: 'WiWU Lightning Stereo Wired Earbuds EB319 — High-Fidelity Audio for Your Apple Devices - Experience superior sound quality with the WiWU EB319 Lightning Earbuds. Featuring large dynamic drivers for rich audio and a noise-canceling microphone for crystal-clear calls, these earbuds connect directly to your Apple devices for seamless listening. .',
    gallery: [
  ...
  },
  {
    ...
    badge: 'new', rating: 4.6, reviews: 61,
    colors: ['Black'],
    image: 'image/products/cables/CCP3USB 1.webp',
    description: 'The WiWU TITAN LINK Series cable offers a robust 66W charging capability and a versatile triple-port design, allowing you to power up multiple devices simultaneously. Constructed with durable aluminum alloy and nylon braiding, this 1.2m cable ensures reliable performance and longevity.',
    gallery: [
      'image/products/cables/CCP3USB 2.webp',
      'image/products/cables/CCP3USB 1.webp',
      'image/products/cables/CCP3USB 3.webp',
      'image/products/cables/CCP3USBD.jpg'
    ]
  },
  {
    ...
    badge: 'new', rating: 4.6, reviews: 61,
    colors: ['White'],
    image: 'image/products/powerbanks/PB10KB 1.webp',
    description: 'Safe charging with multi-protection system,10000mAh battery capacity,Dual USB outputs + dual inputs',
    gallery: [
      'image/products/powerbanks/PB10KB 2.webp',
      'image/products/powerbanks/PB10KB 1.webp',
      'image/products/powerbanks/PB10KD.jpg'
    ]
  },
  {
